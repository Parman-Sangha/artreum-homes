...
const RidgeviewHouse = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    phone: "",
    selectedProperty: "The Ridgeview House",
    message: "",
    agreeTerms: false,
  });
  ...
  const amenities = [
    "Tray ceiling in the primary suite",
    "Massive bonus room upstairs",
    "Main floor office/5th bedroom",
    "Rear deck & walkout basement setup",
    "Mudroom with direct garage access",
    "Upstairs laundry",
    "Ensuite with dual vanities + walk-in",
            ...
            >
              <div>
                ...
                <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-gray-300 leading-relaxed">
                  The Ridgeview House is a luxurious family home offering
                  spacious living areas and modern amenities. With its
                  thoughtful design and premium features, it's the perfect blend
              ...
              <div className="flex flex-wrap justify-between gap-6 mt-8">
                ...
                <div className="flex items-center space-x-4">
                  <div className="bg-gray-200 dark:bg-[#1A1A1A] p-4 rounded-full">
                    <Cube size={48} className="text-[#CDB937]" />
                  </div>
                  <div>
                    <p className="text-xl text-gray-600 dark:text-gray-400">
                      Garage
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                ...
                and plan your investment in The Ridgeview House.
              </p>
