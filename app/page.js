...
const HomePage = () => {
  ...
  return (
    <div className="bg-light-bg dark:bg-dark-bg text-gray-900 dark:text-white min-h-screen">
      ...
      <section className="relative h-[80vh]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-center z-10 px-6">
          <motion.h1
            ...
            initial="initial"
            animate="animate"
            className="font-serif text-5xl md:text-6xl font-bold mb-6 text-white"
          >
      ...
      {/* Communities Section */}
      <section id="communities" className="py-20 bg-light-bg dark:bg-dark-bg">
        <div className="container mx-auto px-6">
          <motion.div
            ref={communitiesRef}
            variants={fadeInUp}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-primary font-bold mb-4">$1,000,000</p>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-primary font-bold mb-4">$650,000</p>
